...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.CreateBy = field.NewString(tableName, "create_by")
	_role.UpdateBy = field.NewString(tableName, "update_by")
	...
	_role.RoleDesc = field.NewString(tableName, "role_desc")
...
type role struct {
	...
	RoleCode  field.String // 角色code
	RoleDesc  field.String // 角色描述
...
func (r *role) updateTableName(table string) *role {
	...
	r.RoleDesc = field.NewString(table, "role_desc")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["role_desc"] = r.RoleDesc
