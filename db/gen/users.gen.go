...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserGender = field.NewString(tableName, "user_gender")
	_user.NickName = field.NewString(tableName, "nick_name")
	_user.UserPhone = field.NewString(tableName, "user_phone")
...
type user struct {
	...
	UserGender field.String // 性别（1-男，2-女）
	NickName   field.String // 昵称
	UserPhone  field.String // 电话
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserGender = field.NewString(table, "user_gender")
	u.NickName = field.NewString(table, "nick_name")
	u.UserPhone = field.NewString(table, "user_phone")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_phone"] = u.UserPhone
